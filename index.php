...
<div class="wrapper">
    <div class="main-top">
        ...
        <p class="about cursive center">Мы подготовили для Вас лучшие новинки сезона</p>
        <div class="button uppercase center"> <a href="/catalog.php?id=4"> посмотреть новинки</a></div>
    </div>
    <div class="main-center">
        <div class="cards">
           <div class="cards-box cards-left ">
                ...
                <div class="cards-box cards-center">
                ...
                <div class="cards-box cards-center-center">
            ...
            <div class="cards-box cards-right wrap">
                <div class="cards-item square bgc-dark-gray">
                    <a class = "to-catalog" href="">
                        <svg class="svg-icon" viewBox="0 0 20 20">
                            <path fill="white" d="M18.271,9.212H3.615l4.184-4.184c0.306-0.306,0.306-0.801,0-1.107c-0.306-0.306-0.801-0.306-1.107,0
